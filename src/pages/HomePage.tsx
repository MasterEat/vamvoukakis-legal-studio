  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Εξειδικευμένες νομικές υπηρεσίες για ιδιώτες και επιχειρήσεις στην Αθήνα και την Αττική. Αστικό, Ποινικό, Εμπορικό Δίκαιο και Δίκαιο Ακινήτων."
        canonical="/"
        ...
        <div className="relative container-wide pt-28 pb-20 md:pt-36">
          <div className="max-w-3xl">
            ...
            <p className="text-primary-foreground/80 text-base md:text-lg font-body leading-relaxed max-w-xl mb-10">
              Εξειδικευμένες νομικές υπηρεσίες για ιδιώτες και επιχειρήσεις στην Αθήνα και την Αττική.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="text-muted-foreground font-body text-sm flex items-start gap-2">
                  <span className="text-accent mt-1">—</span> Πειραιώς 6, Ομόνοια
                </li>
              </ul>
      ...
      <section className="section-padding bg-primary">
        <div className="container-narrow text-center">
          ...
          <p className="text-primary-foreground/70 font-body mb-4">Πειραιώς 6, Ομόνοια, ΤΚ 10434</p>
