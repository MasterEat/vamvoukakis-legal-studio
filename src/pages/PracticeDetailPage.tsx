...
export function CivilLawPage() {
  return <PracticeDetailPage
    ...
    metaDesc="Εξειδικευμένες υπηρεσίες αστικού δικαίου: οικογενειακό, κληρονομικό, ενοχικό και εμπράγματο δίκαιο στην Ομόνοια και Αθήνα."
...
export function CriminalLawPage() {
  return <PracticeDetailPage
    ...
    metaDesc="Ποινική υπεράσπιση και νομική εκπροσώπηση σε υποθέσεις κάθε βαθμού. Δικηγορικό Γραφείο Βαμβουκάκη, Ομόνοια."
...
export function RealEstateLawPage() {
  return <PracticeDetailPage
    ...
    metaDesc="Αγοραπωλησίες, μισθώσεις, κτηματολόγιο και διαχείριση ακίνητης περιουσίας. Δικηγορικό Γραφείο Βαμβουκάκη, Ομόνοια."
