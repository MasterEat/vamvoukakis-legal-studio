...
const ARTICLE_IMAGE = "/articles/deepfakes-nomiko-arthro.webp";
    ...
    <Layout>
      ...
      <section className="section-padding bg-background">
        <div className="container-narrow">
          ...
          <section className="mt-10 border-t border-border pt-6 text-muted-foreground font-body leading-relaxed">
            <p className="font-semibold text-foreground">Βαμβουκάκης Εμμανουήλ</p>
            <p>Δικηγόρος</p>
            <p>Απόφοιτος Νομικής Σχολής Πανεπιστημίου Marburg, Γερμανία</p>
            <p>LL.M. Αστικού Δικαίου, Νομική Σχολή Πανεπιστημίου Αθηνών (ΕΚΠΑ)</p>
            <p>Υποψήφιος Διδάκτωρ Νομικής Σχολής Πανεπιστημίου Αθηνών (ΕΚΠΑ)</p>
          </section>
