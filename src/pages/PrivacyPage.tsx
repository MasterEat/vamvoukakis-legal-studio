      ...
      <section className="section-padding bg-background">
        <div className="container-narrow">
          ...
          <div className="space-y-6 text-muted-foreground font-body leading-relaxed">
            ...
            <p>Δικηγορικό Γραφείο Βαμβουκάκη Εμμανουήλ, Γούναρη 5Α, Κεφαλάρι - Κηφισιά.</p>
            ...
            <p>Έχετε δικαίωμα πρόσβασης, διόρθωσης, διαγραφής και φορητότητας των δεδομένων σας. Για κάθε αίτημα, επικοινωνήστε μαζί μας στο info@advocat.gr.</p>
          </div>
        </div>
      </section>
    </Layout>
