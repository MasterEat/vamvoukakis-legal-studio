...
export default function PracticeAreasPageEn() {
  return (
    <Layout>
      <SEOHead title="Civil & Real Estate Law in Athens | Legal Services" description="Specialized legal services in Civil, Criminal, Commercial and Real Estate Law. Vamvoukakis Law Office." canonical="/en/practice-areas" lang="en" hrefLangs={[{ lang: "el", href: "/tomeis-eidikefsis" }, { lang: "en", href: "/en/practice-areas" }, { lang: "de", href: "/de/rechtsgebiete" }]} />
