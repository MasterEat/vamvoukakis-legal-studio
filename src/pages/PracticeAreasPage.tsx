...
export default function PracticeAreasPage() {
  return (
    <Layout>
      <SEOHead title="Τομείς Ειδίκευσης" description="Εξειδικευμένες νομικές υπηρεσίες σε Αστικό, Ποινικό, Εμπορικό Δίκαιο και Δίκαιο Ακινήτων. Δικηγορικό Γραφείο Βαμβουκάκη." canonical="/tomeis-eidikefsis" />
